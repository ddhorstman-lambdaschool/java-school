    ...
    implements CoursesService
{
    ...
    public Course save(Course course)
    {
        ...
        if (course.getCourseid() != 0)
        {
            ...
            Course existingCourse = courserepos.findByCoursename(course.getCoursename());
            if (existingCourse != null){
                throw new ResourceFoundException("A course with the name "+course.getCoursename()+" already exists!");
            }
        }
